...
function testAge(age) {
  if (age < 18) {
    result = "kamu jahat <br> dia gasuka kamu"; // jika umurnya kurang dari 18
  } else {
    if (age >= 18 && age <= 60) {
...
function yourHead(me) {
  switch (me) {
    case "uang":
      result = "saya punya uang"; //case pertama
      break;
    case "pacar":
      result = "saya punya pacar"; // case kedua
      break;
    default:
      result = "saya tidak punya uang dan pacar"; // case jika tidak terisi maka mengembalikan deafult
      break;
  }
  return result;
}
...
//while
const pacar = ["fahmi", "riski", "farel", "kasih"];
let text = "";
